/**
 * aoi project — stub implementation (#523).
 *
...
const TRACK_URL = "https://github.com/Soul-Brews-Studio/aoi-js/issues/523";
...
export function helpText(): string {
  return [
    "usage: aoi project <learn|incubate|find|list> [args...]",
