 ...
 *      repoRoot = `/home/neo/Code/github.com/doctorboyz/ki-js`
 *      → rel = `doctorboyz/ki-js` → slug = `doctorboyz/ki-js`
 *
 *   B. bare ghq root:     `/home/neo/Code`
 *      repoRoot = `/home/neo/Code/github.com/doctorboyz/ki-js`
 *      → rel = `github.com/doctorboyz/ki-js` → (strip host) →
 *        `doctorboyz/ki-js` → slug = `doctorboyz/ki-js`
 *
