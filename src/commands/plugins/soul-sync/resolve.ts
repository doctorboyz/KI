 ...
 *      repoRoot = `/home/neo/Code/github.com/Soul-Brews-Studio/aoi-js`
 *      → rel = `Soul-Brews-Studio/aoi-js` → slug = `Soul-Brews-Studio/aoi-js`
 *
 *   B. bare ghq root:     `/home/neo/Code`
 *      repoRoot = `/home/neo/Code/github.com/Soul-Brews-Studio/aoi-js`
 *      → rel = `github.com/Soul-Brews-Studio/aoi-js` → (strip host) →
 *        `Soul-Brews-Studio/aoi-js` → slug = `Soul-Brews-Studio/aoi-js`
 *
