import { getTriggers, getTriggerHistory } from "../../sdk";
...
export async function cmdTriggers(): Promise<void> {
  ...
  "triggers": [
    { "on": "issue-close", "repo": "Soul-Brews-Studio/aoi", "action": "aoi hey pulse-oracle 'issue closed'" },
    { "on": "pr-merge", "repo": "Soul-Brews-Studio/aoi", "action": "aoi done neo-aoijs" },
