 ...
 *   src/index.ts      — @ki/sdk hello-world stub
 *   package.json      — author-side deps (typescript, @ki/sdk via workspace)
...
`,
  ...
  // into the ki tree). Phase A: bundler inlines this on `ki plugin build`.
  const pkg = {
    name,
    version: "0.1.0",
    type: "module",
